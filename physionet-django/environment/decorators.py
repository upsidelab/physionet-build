...
cloud_identity_required = _redirect_view_if_user(
    lambda u: not _user_has_cloud_identity(u), "identity_provisioning"
)


skip_if_cloud_identity_exists = _redirect_view_if_user(
    _user_has_cloud_identity, "billing_setup"
)


billing_setup_required = _redirect_view_if_user(
    lambda u: not _user_has_billing_setup(u), "billing_setup"
)


skip_if_billing_setup_exists = _redirect_view_if_user(
    _user_has_billing_setup, "research_environments"
)
