...
get_workspace_list_json = {
    ...
    "workspace-list": [
        {
            "default-appengine-service-status": "stopped",
            "email-id": "karoltest@healthdatanexus.ai",
            "gcp-billing-id": "011E95-8DB815-46BA77",
            "gcp-project-id": "karoltest-us-c1-syhzv",
            "region": "us-central1",
            "user-id": "karoltest",
            "user-status": "user-added-in-cloud-identity",
            "workbench-list": [
                {
                    "bucket-name": None,
                    "build-id": "1a78b5dd-585a-4ee0-b4ef-b5ad6973db78",
                    "creation-timestamp": None,
                    "dataset": "random_value",
                    "id": None,
                    ...
                    "status": None,
                    "type": None,
                    "updatable-config": None,
                    "url": None,
                    "vm_image": None,
                    "workbench-activity-log": [
                        {
            ...
            "workspace-activity-log": [
                {
                    "activity-name": "workspace-creation",
                    "activity-status": "success",
