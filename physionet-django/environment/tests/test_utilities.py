...
from environment.tests.helpers import create_user_with_cloud_identity, create_user_without_cloud_identity, create_user_with_billing_setup
...
class UserHasCloudIdentityTestCase(TestCase):
    def setUp(self):
        ...
        self.user_with_cloud_identity = create_user_with_cloud_identity("laa", "loo", "lee")
...
class UserHasBillingSetupTestCase(TestCase):
    def setUp(self):
        self.user_without_cloud_identity = create_user_without_cloud_identity()
        self.user_with_cloud_identity = create_user_with_cloud_identity("laa", "loo", "lee")
        self.user_with_billing_setup = create_user_with_billing_setup("woo", "waa", "wee")
